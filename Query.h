...
public:
    ...
    virtual QueryResult eval(const TextQuery&) const = 0; //Have to implement
    virtual std::string rep() const = 0; //Have to implement
    static std::shared_ptr<QueryBase> factory(const std::string& s); //Shared to everybody
};
//Case 1: input only one word
